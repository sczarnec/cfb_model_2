...
interpolate_from_buckets <- function(bin_edges, bucket_vals, x, moneyline=FALSE) {
...
spread_edges <- c(0, .01, .02, .03, .08, .15)
spread_vals  <- c(-.04, -.025, .03, .06, .08)
winnings_calc$backtest_spread_ER = interpolate_from_buckets(spread_edges, spread_vals, winnings_calc$cover_confidence)



ml_edges <- c(0, .01, .02, .03, .04, .06, .09, .15, .20)
ml_vals  <- c(-.05, .005, .02, .07, .08, .9, .10,.12)
winnings_calc$backtest_ml_ER = interpolate_from_buckets(ml_edges, ml_vals, winnings_calc$ml_value, TRUE)
