...
# Create training matrix
cp_train_matrix = xgb.DMatrix(data = as.matrix(train[,1:596]), 
                              label = as.numeric(train$t1_actual_cover))

# Create training matrix
cp_test_matrix = xgb.DMatrix(data = as.matrix(test[,1:596]), 
                              label = as.numeric(test$t1_actual_cover))
...
# Create training matrix
op_train_matrix = xgb.DMatrix(data = as.matrix(train[,1:596]), 
                              label = as.numeric(train$actual_over))

# Create training matrix
op_test_matrix = xgb.DMatrix(data = as.matrix(test[,1:596]), 
                              label = as.numeric(test$actual_over))
```
